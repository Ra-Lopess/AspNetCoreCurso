...
namespace SmartSchool.WebAPI.Data {
    public class Repository : IRepository { // lembrar da dependencia, senao da problema na startup
        ...
        public bool SaveChanges() {
            return (_context.SaveChanges() > 0); // checar se real salvou
        }
        ...
        public async Task<PageList<Aluno>> GetAllAlunosAsync(PageParams pageParams, bool includeProfessor = false) {
            ...
            return await PageList<Aluno>.CreateAsync(query, pageParams.PageNumber, pageParams.PageSize); // manda todos alunos que quero listar, e pega os 5 presentes na pagina dois 
        ...
        public Professor[] GetAllProfessoresByDisciplinaId(int disciplinaId, bool includeAlunos = false) {
            ...
            query = query.AsNoTracking().OrderBy(p => p.Id).Where(aluno => aluno.Disciplinas.Any(d => d.AlunosDisciplinas.Any(ad => ad.DisciplinaId == disciplinaId)));
            return query.ToArray();
        }
