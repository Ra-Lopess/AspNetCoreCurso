...
namespace SmartSchool.WebAPI.Data {
    public class DataContext : DbContext { // cria as tabelas de cada Model
        public DataContext(DbContextOptions<DataContext> options) : base(options) { } // acessa as config do banco, tipo nossa connectionString
        public DbSet<Aluno> Alunos { get; set; }
        public DbSet<Professor> Professores { get; set; }
        public DbSet<Disciplina> Disciplinas { get; set; }
        public DbSet<AlunoDisciplina> AlunoDisciplinas { get; set; }

        protected override void OnModelCreating(ModelBuilder builder) { // método pra mostrar o relacionamento N : N entre aluno e disciplina
            builder.Entity<AlunoDisciplina>().HasKey(AD => new {AD.AlunoId, AD.DisciplinaId });

            // aqui é a carga inicial de dados pra inserir no banco
